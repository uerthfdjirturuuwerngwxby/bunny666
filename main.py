...
def main():
    ...
    st.sidebar.markdown(''' --[about us](https://www.instagram.com/_ly_pooja/?igsh=MWl6dWJvajFjdHB5bA%3D%3D)''')
    st.sidebar.markdown('''--[contact us](https://www.instagram.com/_ly_pooja/?igsh=MWl6dWJvajFjdHB5bA%3D%3D) ''')

    st.sidebar.write('made by 🖕🫦')
    
    st.header('''Inspired By 🍑🫦''')
